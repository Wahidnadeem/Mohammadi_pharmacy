         ...
         <div id="page-wrapper">
            ...
            <div class="content">
               ...
               <?php // require_once("message.php");?>
                 ...
                 <a id="export_button" href="report_exit_durg.php" class="btnc btnc-primary btnc-icon-anim pointer" style="text-decoration: none; bottom: 12px;" target="_blank" >
                        <i class="fa fa-file-excel-o"></i>&nbsp;
                        <span class="ladda-label bfont">خروجی اکسل</span>&nbsp;
                  </a>
                    &nbsp;
                  <a href="report_exit_durg.php" class="btnc btnc-success btnc-icon-anim pointer" style="text-decoration: none; bottom: 12px;">
                        <i class="fa fa-rotate-left"></i>&nbsp;
                        <span class="ladda-label bfont">برگشت  به لیست  موجودی دوا ها</span>&nbsp;
                  </a>
