<?php 
    ...
    $category_row     = select_one('categories',$id);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body class="body" style="scrollbar-width: thin;">
        ...
        <div id="wrapper" class="wrapper animsition">
            ...
            <!-- /.Navigation -->
            <?php $menu = "category"; $sub = "a";$page= "tr_a.php"; ?>
            <!-- Sidebar -->
                        ...
                        <div style="background:white;padding:10px;padding-top:6px;padding-bottom:7px;">
                            <div class="header-title" style="margin-right:0px;">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"> ویرایش کتگوری</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="panel panel-warning lobidisable">
                                ...
                                <div class="panel-body bfont">
                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_category.php">               
                                        ...
                                        <input type="hidden" name="id" id="id" value="<?php echo base64_encode($category_row['id']);?>">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="name" value="<?php if(isset($category_row['name'])) echo $category_row['name'];?>" name="name" required="required" class="form-control cfont" placeholder="مثلا: انلجیزیک"  >
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <?php if(isset($category_row['date'])) echo $category_row['date'];?>
                                            </div>
                                        </div>
