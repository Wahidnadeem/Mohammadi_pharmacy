                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_stock.php" >
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="name" name="name" onblur="is_dublicate(this.value,)" required="required" class="form-control cfont"  placeholder = "مثلا : گدام بالا">
                                            </div>
                                            <span id="stock_dublicate" style="display: none;color: red; ">این  گدام تکراری است  ! </span>
                                        </div>
...
<script type="text/javascript">
     function is_dublicate(name){
        $.ajax ({
            ...
            data: {
                   name  :name,
                   type  :"stock_dublicate"},
            success:function(data){
                if(data == "true"){
                    $('#stock_dublicate').show();
                }else{
                    $('#stock_dublicate').hide();
                }
            }
        });
        }
