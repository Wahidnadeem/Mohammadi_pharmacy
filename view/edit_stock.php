                        ...
                        <div style="background:white;padding:10px;padding-top:6px;padding-bottom:7px;">
                            <div class="header-title" style="margin-right:0px;">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"> ویرایش گدام</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 m-b-20">
                            <div class="panel panel-warning lobidisable">
                                ...
                                <div class="panel-body bfont">
                                    <br>
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_stock.php">               
                                        
                                        <input type="hidden" name="edit" value="1">
                                        <input type="hidden" name="id" id="id" value="<?php echo base64_encode($stock_row['id']);?>">
                                        <input type="hidden" name="current_date" value="<?php if(isset($stock_row['date'])) echo $stock_row['date']  ?>"  >

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-12 col-xs-12 col-lg-3" for="name"> نام  گدام <span class="required">*</span></label>
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="name" value="<?php if(isset($stock_row['name'])) echo $stock_row['name'];?>" name="name" required="required" class="form-control cfont" placeholder = "مثلا : گدام بالا">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <?php if(isset($stock_row['date'])) echo $stock_row['date'];?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <textarea id="note" name="note" class="form-control" rows="5" style="width:100%;height:20%;overflow-x:auto;" placeholder="لازمی نیست"><?php if(isset($stock_row['note'])) echo $stock_row['note'];?></textarea>
                                            </div>
                                        </div>
