                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="tr_aac.php">               
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-9 col-lg-offset-3">
                                                <button type="submit" class="btn btn-warning" name="send_save"><i class="fa fa-edit"> </i> ویرایش</button>
                                                <button type="reset" class="btn btn-danger"><i class="fa fa-refresh"> </i> لغو یا بازکشت</button>
                                            </div>
                                        </div>
