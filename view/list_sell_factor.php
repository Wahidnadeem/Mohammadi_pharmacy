<?php
  ...
  $view_data->execute(['deleted' => 0 , 'type' =>'sell' ]);

  $list_data  = $db->query("SELECT count(id) as record FROM buy_sell_drug WHERE deleted = 0 AND `type` = 'sell' $condition ")->fetch();
    ...
    <body class="body" style="scrollbar-width: thin;">
        ...
        <div id="wrapper" class="wrapper animsition">
            ...
            <div id="page-wrapper">
                            ...
                            <div class="panel panel-default lobidisable">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4 class=" bold bfont"><i class="fa fa-inbox"> </i>  جستجو  فاکتور فروش </h4>
                                    </div>
                                </div>
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control basic-single" dir="rtl" name="customer_id" id="customer_id">
                                                            ...
                                                            <?php
                                                                $customers = $db->query("SELECT * FROM customers WHERE `type` = 'buyer' AND deleted = '0' ORDER BY id DESC");
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <a  href="list_sell_factor.php"  class="btn btn-danger"><i class="fa fa-clone"> </i> تازه سازی</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <a href="excel_sell_factor.php?condition=<?php echo $condition;?>" class="btnc btnc-primary btnc-icon-anim pointer" style="text-decoration: none; bottom: 12px;" target="_blank" >
                    ...
                    <div class="panel panel-default lobidisable">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4 class="gray bold bfont"><i class="fa fa-inbox"></i> لیست فاکتور  های فروش ، آخرین موارد ثبت شده.</h4>
                            </div>
                        </div>
                                            ...
                                            foreach ($view_data as $key => $row) {
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <a href="edit_sell_factor.php?id='.base64_encode($row['id']).'" class="left"><button type="button" class="btnc btnc-success btnc-icon-anim btnc-circle" style="width:30px;height:30px;"><i class="fa fa-edit"></i></button></a>
                                                        <a class="left delete-row"  href="action_sell_factor.php?delete&id='.base64_encode($row['id']).'"><button type="button" class="btnc btnc-danger btnc-icon-anim btnc-circle" style="width:30px;height:30px;"><i class="fa fa-trash-o"></i></button></a>
                                                        <a target="_blank" href="pdf_buy_factor.php?id='.base64_encode($row['id']).'"><button type="button" class="btnc btnc-primary btnc-icon-anim btnc-circle" style="width:30px;height:30px;"><i class="fa fa-file-pdf-o"></i></button></a>
                                                        </td>
                                                        </tr>
                                                        ';
                                                    }
                                                    // <a target="_blank" href="add_one_sell_factor_assets.php?id='.base64_encode($row['id']).'"><button type="button" class="btnc btnc-info btnc-icon-anim btnc-circle" style="width:30px;height:30px;"><i class="fa fa-plus"></i></button></a>
             ...
             <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="height: 60px;">
                        ...
                        <h1 class="modal-title mb-20">جزییات فاکتور فروش</h1>
                    </div>
