...
require_once "_config.php";
  ...
  $view_data = $db->prepare("SELECT * FROM `customer_transaction` WHERE `type` = 'buyer' AND `amount` > 0  $condition ORDER BY id DESC LIMIT $to OFFSET $from");
  $view_data->execute();

  $list_data  = $db->query("SELECT count(id) as record FROM customer_transaction WHERE `type` = 'buyer'  AND `amount` > 0  $condition ")->fetch();
...
<html lang="en">
    ...
    <body class="body" style="scrollbar-width: thin;">
        ...
        <div id="wrapper" class="wrapper animsition">
            ...
            <!-- /.Navigation -->
            <?php $menu = "report"; $sub = "report_credit_customer";?>
            <!-- Sidebar -->
            ...
            <div id="page-wrapper">
                ...
                <div class="content">
                    ...
                    <a href="excel_report_credit_customer.php?condition=<?php echo $condition;?>" class="btnc btnc-primary btnc-icon-anim pointer" style="text-decoration: none; bottom: 12px;" target="_blank" >
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4 class="gray bold bfont"><i class="fa fa-inbox"></i> لیست مشتری های طلب کار </h4>
                            </div>
                        </div>
