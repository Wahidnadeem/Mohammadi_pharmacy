<?php 
    ...
    $buy_factor_row     = select_one('buy_sell_assets',$id);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                            ...
                            <div class="panel panel-warning lobidisable">
                                ...
                                <div class="panel-body bfont">
                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_buy_factor.php">               
                                        ...
                                        <input type="hidden" name="edit_buy_sell_assets" value="1">
                                        <input type="hidden" name="id" id="id" value="<?php echo base64_encode($buy_factor_row['id']);?>">
                                        <input type="hidden" name="current_date" value="<?php if(isset($buy_factor_row['expire_date'])) echo $buy_factor_row['expire_date']  ?>"  >
                                                    ...
                                                    <option value="">یکی را انتخاب کنید</option>
                                                      <?php
                                                            ...
                                                            foreach ($drug as $rows){
                                                                if ($rows['id'] == $buy_factor_row['drug_id']) {
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="amount" value="<?php if(isset($buy_factor_row['amount'])) echo $buy_factor_row['amount'];?>" name="amount" required="required" class="form-control cfont" placeholder="مثلا : 22">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" step="any" id="unit_price" value="<?php if(isset($buy_factor_row['unit_price'])) echo $buy_factor_row['unit_price'];?>" name="unit_price" required="required" class="form-control cfont" placeholder="مثلا : 22">
                                            </div>
                                        </div>
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="number" id="price" step="any" value="<?php if(isset($buy_factor_row['price'])) echo $buy_factor_row['price'];?>" name="price" required="required" class="form-control cfont" placeholder="مثلا : 1000">
                                            </div>
                                        </div>
                                                    ...
                                                    <option value="">یکی را انتخاب کنید</option>
                                                      <?php
                                                            ...
                                                            foreach ($stock as $rows){
                                                                if ($rows['id'] == $buy_factor_row['stock_id']) {
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-12 col-xs-12 col-lg-3" for="expire_date"> تاریخ قبلی </label>
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <?php if(isset($buy_factor_row['expire_date'])) echo $buy_factor_row['expire_date'];?>
                                            </div>
                                        </div>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-12 col-xs-12 col-lg-3" for="expire_date"> تاریخ </label>
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="date" id="expire_date" name="expire_date" autocomplete="off" class="form-control "  placeholder="تاریخ">
                                            </div>
                                        </div>
