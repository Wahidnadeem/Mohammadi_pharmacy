<?php 
    ...
    $sell_factor_row     = select_one('buy_sell_drug',$id);
    
    $buy_sell_id = $sell_factor_row['id'];
                            ...
                            <div class="panel panel-warning lobidisable">
                                ...
                                <div class="panel-body bfont">
                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_sell_factor.php">               
                                        ...
                                        <input type="hidden" name="current_date" value="<?php if(isset($sell_factor_row['date'])) echo $sell_factor_row['date']  ?>"  >
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="code_number" value="<?php if(isset($sell_factor_row['code_number'])) echo $sell_factor_row['code_number'];?>" name="code_number" required="required" class="form-control cfont" readonly ="">
                                            </div>
                                        </div>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-12 col-xs-12 col-lg-3" for="customer_id">  مشتری    <span class="required">*</span></label>
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <select class="form-control basic-single" dir="rtl" name="customer_id" id="customer_id" required>
                                                    <option value="">یکی را انتخاب کنید</option>
                                                      <?php
                                                            $customer = $db->query("SELECT * FROM `customers` WHERE `deleted` = '0' AND `type` = 'buyer' ORDER BY id DESC");
                                                            foreach ($customer as $rows){
                                                                if ($rows['id'] == $sell_factor_row['customer_id']) {
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="number" id="payment_amount" onkeyup="calculate_remain_price(this.value, total_amount.value)" step = "any" value="<?php if(isset($customer_buy_sell_payment['payment_amount'])) echo $customer_buy_sell_payment['payment_amount']  ?>" name="payment_amount" required="required" class="form-control cfont" placeholder="مثلا : 0">
                                            </div>
                                        </div>
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="number" id="remain" step = "any" value="<?php if(isset($customer_buy_sell_payment['remain_amount'])) echo $customer_buy_sell_payment['remain_amount']  ?>" name="remain" required="required" class="form-control cfont" readonly = "" placeholder="مثلا : 0 ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <?php if(isset($sell_factor_row['date'])) echo $sell_factor_row['date'];?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <textarea id="note" name="note" class="form-control" rows="5" style="width:100%;height:20%;overflow-x:auto;" placeholder="لازمی نیست"><?php if(isset($sell_factor_row['note'])) echo $sell_factor_row['note'];?></textarea>
                                            </div>
                                        </div>
