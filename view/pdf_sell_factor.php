...
require_once '_config.php';
 ...
 if(!isset($_GET['id'])){
    ...
    $buy_sell_customer = $db->query("SELECT * FROM `buy_sell_drug` WHERE `id` = '$id' AND `deleted` = '0' AND `type` = 'sell'")->fetch();
...
<body>
    <style>
        ...
        @media (min-width: 1400px) {
            .container, .container-lg, .container, .container-sm, .container-xl, .container-xxl {
    ...
    <div class="container">
        <div class="row pt-4 mb-4">
            <div class="col-md-12 text-center h3 ">
                <h3>آدرس :  افغانستان هرات ،شهر نو، جاده عیدگاه، مارکت غزنوی، شرکت عمران ویت فارما</h3>
            </div>
        </div>
