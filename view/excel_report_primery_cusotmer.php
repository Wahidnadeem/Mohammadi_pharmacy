...
$condition = $_GET['condition'];
  $view_data = $db->prepare("SELECT * FROM `customer_transaction` WHERE `type` = 'primery' AND `amount` > 0  $condition ORDER BY id DESC");
  $view_data->execute();
        ...
        <div id="wrapper" class="wrapper animsition">
            ...
            <div id="page-wrapper">
                ...
                <div class="content">
                    ...
                    <a id="export_button" href="report_primery_customer.php" class="btnc btnc-primary btnc-icon-anim pointer" style="text-decoration: none; bottom: 12px;" target="_blank" >
                        <i class="fa fa-file-excel-o"></i>&nbsp;
                        <span class="ladda-label bfont">خروجی اکسل</span>&nbsp;
                    </a>
                    &nbsp;
                     <a href="report_primery_customer.php" class="btnc btnc-success btnc-icon-anim pointer" style="text-decoration: none; bottom: 12px;">
                        <i class="fa fa-rotate-left"></i>&nbsp;
                        <span class="ladda-label bfont">برگشت  به  حساب های متفرقه </span>&nbsp;
                    </a>
