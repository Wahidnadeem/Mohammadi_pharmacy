                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_user.php" >               
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="full_name" name="full_name" required="required" class="form-control cfont"  placeholder="مثلا : احمد محمدی"  >
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="father_name" name="father_name" class="form-control cfont"  placeholder="مثلا : محمد داوود"  >
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="phone" name="phone" required="required" class="form-control cfont"  placeholder=" مثلا : 0700400300"  >
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="username" name="username" required="required" class="form-control cfont"  placeholder="مثلا : AhmadMohammadi"  >
                                            </div>
                                        </div>
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="password" name="password" required="required" class="form-control cfont"  placeholder=" مثلا : Ah1234"  >
                                            </div>
                                        </div>
