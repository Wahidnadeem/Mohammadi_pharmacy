...
<html lang="en">
    ...
    <body class="body" style="scrollbar-width: thin;">
        ...
        <div id="wrapper" class="wrapper animsition">
            ...
            <!-- /.Navigation -->
              <?php $menu = "transform_money"; $sub = "add_transform_money";?>
            <!-- Sidebar -->
                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_transform_money.php">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="number" id="number" required="required" name="number" class="form-control cfont" placeholder="مثلا : 2390">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="sender_customer" name="sender_customer" required="required" class="form-control cfont" placeholder="مثلا : احمد محمدی">
                                            </div>
                                        </div>                                      
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                 <select class="form-control basic-single" dir="rtl" required name="money_type" id="money_type" >
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="number" id="cost" name="cost" required="required" class="form-control cfont"  placeholder="مثلا : 10000"  >
                                            </div>
                                        </div>

                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-12 col-xs-12 col-lg-3" for="send_date"> تاریخ  اجرا حواله  <span class="required">*</span></label>
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="send_date" value="<?php echo $PDATE ?>" name="send_date" required="required" class="form-control p-date"  placeholder="تاریخ">
                                            </div>
                                        </div>
