                                ...
                                <div class="panel-body bfont">
                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_drug.php">               
                                        ...
                                        <input type="hidden" name="id" id="id" value="<?php echo base64_encode($drug_row['id']);?>">
                                         <input type="hidden" name="current_date" value="<?php if(isset($drug_row['date'])) echo $drug_row['date']  ?>"  >
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <select class="form-control basic-single" dir="rtl" name="category_id" id="category_id" required>
                                                    <option value="">یکی را انتخاب کنید</option>
                                                      <?php
                                                            $catgory = $db->query("SELECT * FROM `categories` WHERE `deleted` = '0' ORDER BY id DESC");
                                                            foreach ($catgory as $rows){
                                                                if ($rows['id'] == $drug_row['category_id']) {
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-12 col-xs-12 col-lg-3" for="drug_code"> کد دوا <span class="required">*</span></label>
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="drug_code" value="<?php if(isset($drug_row['drug_code'])) echo $drug_row['drug_code'];?>" name="drug_code" required="required" class="form-control cfont" placeholder="مثلا: انلجیزیک"  >
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="scientific_name" value="<?php if(isset($drug_row['scientific_name'])) echo $drug_row['scientific_name'];?>" name="scientific_name" required="required" class="form-control cfont" placeholder="مثلا: انلجیزیک"  >
                                            </div>
                                        </div>

                                         <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-12 col-xs-12 col-lg-3" for="company_name"> نام  شرکتی <span class="required">*</span></label>
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="company_name" value="<?php if(isset($drug_row['company_name'])) echo $drug_row['company_name'];?>" name="company_name" required="required" class="form-control cfont" placeholder="مثلا: انلجیزیک"  >
                                            </div>
                                        </div>
