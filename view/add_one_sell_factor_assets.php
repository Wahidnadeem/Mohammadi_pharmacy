                            ...
                            <div class="panel panel-warning lobidisable">
                                ...
                                <div class="panel-body bfont">
                                    ...
                                    <form id="validation-form" class="form-horizontal form-label-left" method="post" action="action_sell_factor.php">               
                                        ...
                                        <input type="hidden" name="insert_one_sell_factor_assets" value="1">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="amount" name="amount" required="required" class="form-control cfont" placeholder="مثلا : 22">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" step="any" id="unit_price"   name="unit_price" required="required" class="form-control cfont" placeholder="مثلا : 1000">
                                            </div>
                                        </div>
                                         ...
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5">
                                                <input type="text" id="price" name="price" required="required" class="form-control cfont" placeholder="مثلا : 1000">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="send_save"><i class="fa fa-clone"> </i> ثبت و جدید</button>
                                                <a href="list_sell_factor.php">
                                                    <button type="button" class="btn btn-danger"><i class="fa fa-refresh"> </i> لغو یا بازکشت</button>
                                                </a>
                                            </div>
                                        </div>
