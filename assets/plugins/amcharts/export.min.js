AmCharts.translations.export || (AmCharts.translations.export = {}), AmCharts.translations.export.en || (AmCharts.translations.export.en = {
        ...
        "menu.label.print": "چاپ",
        "menu.label.undo": "عقب",
        "menu.label.redo": "جلو",
        "menu.label.cancel": "Cancel",
        "menu.label.save.image": "دانلود",
        "menu.label.save.data": "ثبت",
        "menu.label.draw": "انوتیت",
        "menu.label.draw.change": "تغییر",
        "menu.label.draw.add": "اضافه کردن",
        "menu.label.draw.shapes": "شیپ",
        "menu.label.draw.colors": "رنگ",
        "menu.label.draw.widths": "سایز",
        "menu.label.draw.opacities": "اوپسیتی",
        "menu.label.draw.text": "متن",
        "menu.label.draw.modes": "مد",
        "menu.label.draw.modes.pencil": "پنسل",
        "menu.label.draw.modes.line": "خط",
        "menu.label.draw.modes.arrow": "جهتها",
                            ...
                            return function(c, i) {
                                ...
                                for (a.offset.absolute ? (void 0 !== a.offset.bottom ? n.top = g.height - a.offset.height - a.offset.bottom : n.top = a.offset.top, void 0 !== a.offset.right ? n.left = g.width - a.offset.width - a.offset.right : n.left = a.offset.left) : (n.top = a.offset.y, n.left = a.offset.x), j = 0; j < l.paths.length; j++) {
                                    ...
                                    if (l.paths[j]) {
                                        ...
                                        if (l.paths[j].fill instanceof Object) "radial" == l.paths[j].fill.type && -1 == ["pie", "gauge"].indexOf(d.setup.chart.type) && (l.paths[j].fill.coords.r2 = -1 * l.paths[j].fill.coords.r1, l.paths[j].fill.coords.r1 = 0, l.paths[j].set({
                    ...
                    function g(b, c) {
                        ...
                        for (e = 0; e < b.length; e++) {
                            ...
                            if (j.format = String(j.format).toUpperCase(), l.addEventListener("focus", function(a) {
                                ...
                                }, j) : j.label || (j.label = j.label ? j.label : d.i18l("menu.label." + o)), (-1 == ["CSV", "JSON", "XLSX"].indexOf(j.format) || -1 == ["map", "gauge"].indexOf(d.setup.chart.type)) && (d.setup.hasBlob || "UNDEFINED" == j.format || !j.mimeType || "image" == j.mimeType.split("/")[0] || "text/plain" == j.mimeType)) {
                                ...
                                }(j)), k.appendChild(l), d.isElement(j.label) ? n.appendChild(j.label) : n.innerHTML = j.label, j.class && (k.className = j.class), j.style && k.setAttribute("style", j.style), j.icon && (m.setAttribute("src", (j.ignore || -1 != j.icon.slice(0, 10).indexOf("//") ? "" : a.pathToImages) + j.icon), l.appendChild(m)), j.label && l.appendChild(n), j.title && l.setAttribute("title", j.title), d.config.menuReviver && (k = d.config.menuReviver.apply(d, [j, k])), j.elements = {
                                    li: k,
                                    a: l,
                                    img: m,
                                    span: n
